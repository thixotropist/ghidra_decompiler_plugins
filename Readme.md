...
$ bazelisk build -c opt @ghidra//:decompile
...
The top level command `bazelisk build --platforms=//extras/platforms:riscv64 @whisper//:whisper-cli` will fetch the 1.8.2
...
```console
$ bazelisk build --platforms=//extras/platforms:riscv64 @whisper//:whisper-cli
...
