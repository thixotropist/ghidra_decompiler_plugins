...
# Optionally suspend valgrind tests while debugging other subsystems
...
expected = {
    ...
    'whisper_sample_12':  {'vector_memset':2, 'vector_memcpy':8, 'vector_strlen':1},
